#C 2014 Hake control file
#C run 21 with time-varying fishery selectivity starting in 1991
###################################################
...
# Tune sample sizes
# Check bounds on R0
# Years on start and end of recr devs
# Ages to estimate for selex
# variability on selex
###################################################
...
# Females
0.05  0.4   0.2   -1.609438 3   0.1 5 0 0 0 0 0 0 0 # M
15  40  28  32  -1  99  3 0 0 0 0 0 1 2 # A0
45  70  60  50  -1  99  3 0 0 0 0 0 1 2 # Linf
0.03  0.5 0.18  0.3 -1  99  3 0 0 0 0 0 1 2 # VBK
0.03  0.16  0.1196  0.1 -1  99  4 0 0 0 0 0 0 0 # CV of length at age 0
0.03  0.16  0.1196  0.1 -1  99  4 0 0 0 0 0 0 0 # CV of length at age inf
# Males
0.05  0.4   0.2   -1.609438 3   0.1 5 0 0 0 0 0 0 0 # M
15  40  28  32  -1  99  3 0 0 0 0 0 1 2 # A0
45  70  55  50  -1  99  3 0 0 0 0 0 1 2 # Linf
0.03  0.5 0.3 0.3 -1  99  3 0 0 0 0 0 1 2 # VBK
0.03  0.16  0.1196  0.1 -1  99  4 0 0 0 0 0 0 0 # CV of length at age 0
0.03  0.16  0.1196  0.1 -1  99  4 0 0 0 0 0 0 0 # CV of length at age inf
...
# Males W-L
-3  3 0.0000138048 1  -1  99  -50 2 0 0 0 0 0 0 # M W-L slope
-3  3 2.790275     1  -1  99  -50 0 0 0 0 0 0 0 # M W-L exponent
